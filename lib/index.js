...
function postNewFavorite() {
  ...
  var url = `https://thawing-basin-85011.herokuapp.com/api/v1/favorites?api_key=${config.apiKey}&location=Minneapolis,MS`
...
function getFavorites() {
  var xhr = new XMLHttpRequest();
  var url = `https://thawing-basin-85011.herokuapp.com/api/v1/favorites?api_key=${config.apiKey}`
