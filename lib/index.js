...
function displayRegister() {
  clearContents(["favorite", "forecast", "email", "loaded-favorites"]);
  deleteSession();
  document.getElementById("display").innerHTML = "<input id='email' type='text' placeholder='Email'> <br> <input id='password' type='text' placeholder='Password'> <br> <input id='password-conf' type='text' placeholder='Password Confirmation'> <br> <button id='login-button' class='button' onclick='createUser()'>Log In</button><br>";
}
