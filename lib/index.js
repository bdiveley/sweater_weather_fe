...
function setLogOut() {
  document.getElementById("user").innerHTML =
  "<li id='user'><h4 class='nav'>Welcome<h4><button id='login-btn' class='nav' onclick='displayLogin()'>Log In</button><button id='register-btn' class='nav' onclick='displayRegister()'>Register</button></li>";
}

function setSweaterDisplay() {
  document.getElementById("display").innerHTML =
  "<img class='sweater' onclick='visitorLogin()'  src='gray-sweater.png' alt='Sweater'/>"
}
