...
function setSearchBar() {
  ...
  "<input id='location' type='text' placeholder='Type any location: Denver, CO'> <br> <button id='locationbutton' class='button' onclick='getForecast()'>Find Weather</button><br> <select id='favorites-list'> <option>Denver, CO</option> <option>Westfield, IN</option></select><br> <button id='favoritebutton' class='button' onclick='getFavoriteForecast()'>Select Favoritest Location</button>"
}
